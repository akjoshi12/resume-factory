...
\newcommand{\myname}{Atri Joshi} % Your name (e.g. "John Smith")
\newcommand{\mytitle}{} % Your title (e.g. "Applicant")
\newcommand{\myemail}{atrijoshi12@gmail.com} % Your email (e.g. "me@mydomain.com")
\newcommand{\mylinkedin}{atrijoshi} % Your LinkedIn profile name (e.g. "myname")
\newcommand{\myphone}{437.662.5837} % Your phone number (e.g. "123.456.7890")
\newcommand{\mylocation}{Toronto, ON} % Your general location (e.g. "PNW, USA")
